...
Umfang: 954 Clips (500 Wörter, 454 Sätze), 10.9 MB in `app/audio/`; Wörter im Schnitt 0.7 s, Sätze 2.7 s. Alle Clips wurden mit `tools/verify_audio.py` (Whisper large-v3) gegengehört; auffällige Clips wurden mit neuen Seeds nachgeneriert, bis nur noch Whisper-Artefakte übrig blieben (z. B. „ve“ → „B“, „silla“ → „Sisha“ = porteño-Aussprache).
